...
<head>
    ...
    <title>Login do Aluno | Professor Eugênio</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        body {
            ...
            /* Imagem não-fixa com 50% de escurecimento (brightness down) */
            background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');
            background-size: cover;
            background-position: center;
            background-attachment: scroll; /* nãofixa */
...
<?php require_once PUBLIC_ROOT . '/componentes/home/v1/nav.php'; ?>
    <main class="flex-grow-1 d-flex justify-content-center align-items-center w-100 py-5">
    ...
    <script src="componentes/scripts/loginUser.js?<?= time() ?>"></script>
</body>
</html>
