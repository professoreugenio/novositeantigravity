        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 fw-medium">
                    ...
                    <li class="nav-item"><a class="nav-link active fw-bold text-primary" href="Depoimentos.php">Depoimentos</a></li>
                    <li class="nav-item"><a class="nav-link" href="Ebooks.php">Ebooks</a></li>
