...
try {
    ...
    if ($codigoUser <= 0 || $idCurso <= 0 || $idTurma === '' || $idPublicacaoAtiva <= 0) {
        jsonResponse([
            'success' => false,
            'inserted' => false,
            'message' => 'Dados inválidos para registrar a pontuação.'
        ], 400);
    }
    ...
    if ($inserted) {
        jsonResponse([
            'success' => true,
            'inserted' => true,
            'message' => 'Você ganhou 50 pontos nesta aula!',
            'tipo' => $tipoPontuacao,
            'pontos' => $pontos,
            'idpublicacao' => $idPublicacaoAtiva
        ]);
    }
    ...
    jsonResponse([
        'success' => true,
        'inserted' => false,
        'message' => 'Pontuação desta aula já registrada hoje.',
        'tipo' => $tipoPontuacao,
        'pontos' => 0,
        'idpublicacao' => $idPublicacaoAtiva
    ]);
    ...
    jsonResponse([
        'success' => false,
        'inserted' => false,
        'message' => 'Erro ao registrar pontuação da aula.',
        'erro' => $e->getMessage()
    ], 500);
}
