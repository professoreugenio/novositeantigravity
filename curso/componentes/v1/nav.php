            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown" id="PainelUsuario">
                        <a href="#" class="auth-pill text-decoration-none dropdown-toggle" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 custom-dropdown" aria-labelledby="userDropdown">
                            ...
                            <li><a id="logoffuser" class="dropdown-item py-2 text-danger" href="#" data-bs-toggle="modal" data-bs-target="#logoutModal"><i class="bi bi-box-arrow-right me-2"></i> Sair</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body text-center p-4">
                    ...
                    <p class="text-muted mb-0">Isso encerrará sua sessão atual e você precisará fazer login novamente para acessar a plataforma de cursos.</p>
                </div>
