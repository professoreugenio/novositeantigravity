...
<head>
    ...
    <title>Atualizar Foto | Professor Eugênio</title>
            ...
            <div class="col-lg-9">
                <div class="card border-0 shadow-sm rounded-4 custom-card p-4 p-md-5 bg-body mb-4">
                    <div class="row g-4 align-items-start">
                            ...
                            <div class="text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-3 mb-3">
                                    ...
                                    <img src="<?= htmlspecialchars($foto50Url, ENT_QUOTES, 'UTF-8') ?>?v=<?= time() ?>"
                                        alt="Miniatura 50"
                                        id="fotoAtualMini"
                                        class="foto-preview-mini">

                                    <div class="text-start">
                                        <div class="fw-bold"><?= $v('nome') !== '' ? $v('nome') : 'Usuário' ?></div>
                                        <div class="text-muted small"><?= $v('email') ?></div>
                                    </div>
                                </div>

                                <div class="alert alert-light border rounded-4 text-start mb-0">
                                    <div class="fw-semibold mb-2">
                                        <i class="bi bi-info-circle me-2 text-primary"></i> Padrões automáticos
                                    </div>
                                    <div class="small text-muted">
                                        <div>• imagem50: avatar quadrado com até 10 KB</div>
                                        <div>• imagem200: foto principal com até 100 KB</div>
                                        <div>• formatos aceitos: JPG, JPEG, PNG, WEBP e GIF</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7">
                            <form id="formUploadFoto" enctype="multipart/form-data" novalidate>
                                <input type="hidden" name="codigocadastro" value="<?= (int)($dadosUser['codigocadastro'] ?? 0) ?>">

                                <div class="upload-dropzone mb-4">
                                    <label for="fotoPerfil" class="form-label fw-bold mb-3">
                                        <i class="bi bi-cloud-arrow-up me-2 text-primary"></i> Selecionar nova foto
                                    </label>
                                    ...
                                    <div class="form-text mt-2">
                                        Envie uma imagem nítida. O sistema recorta, redimensiona e otimiza automaticamente.
                                    </div>
                                </div>

                                <div class="mb-4 d-none" id="boxPreviewNova">
                                    <label class="form-label fw-medium">Pré-visualização do envio</label>
                                    <div class="p-3 border rounded-4 bg-light-subtle text-center">
                                        <img src="/img/usuario.jpg" id="previewNovaFoto" class="foto-preview-grande" alt="Pré-visualização">
                                    </div>
                                </div>

                                <div class="mb-4 d-none" id="boxProgresso">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <label class="form-label fw-medium mb-0">Progresso do envio</label>
                                        <span class="small fw-semibold" id="textoPercentual">0%</span>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap gap-3 pt-3 border-top">
                                    <button type="reset" class="btn btn-light rounded-pill px-4 fw-medium" id="btnResetFoto">
                                        Limpar
                                    </button>

                                    <button type="submit" class="btn btn-custom-primary rounded-pill px-5 fw-bold shadow-sm" id="btnEnviarFoto">
